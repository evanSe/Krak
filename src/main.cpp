...
private:
	...
	void createRenderPass() {
		...
		// change if we do things with the stencil buffer
	...
	void createGraphicsPipeline() {
		...
		multisampling.rasterizationSamples = SAMPLE_COUNT; // Number of samples to use for rasterization
		...
		multisampling.sampleShadingEnable = VK_TRUE; // Enable per-sample shading (instead of per-fragment)
